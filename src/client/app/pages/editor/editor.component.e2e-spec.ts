describe('Editor', () => {
    ...
    it('saving a file should work', () => {
        let saveBtn = element(by.css('.monaco-toolbar .save')),
            filesLink = element(by.css('.primary ng-sidebar aside a.files'));
        ...
        browser.wait(protractor.ExpectedConditions.stalenessOf(element(by.css('.modal-backdrop'))), 1000);
        filesLink.click();
        expect(element.all(by.css('.secondary .files li')).count()).toBe(1);
        expect(element(by.css('.secondary .files .filename')).getText()).toMatch('New title');
        expect(element(by.css('.secondary .files .size')).getText()).toBe('0 bytes');
    ...
    it('files link in sidebar should have correct count', () => {
        let count = element(by.css('ng-sidebar aside ul li a.files .count')),
            emptyLabel = element(by.css('.secondary .files .empty')),
            filesLink = element(by.css('.primary ng-sidebar aside a.files')),
    ...
    it('secondary sidebar toggles when clicking on Files menu', () => {
        let filesLink = element(by.css('.primary ng-sidebar aside a.files')),
            secondarySidebar = element(by.css('.secondary aside'));
    ...
    it('secondary sidebar toggles when clicking on Examples menu', () => {
        let examplesLink = element(by.css('.primary ng-sidebar aside a.examples')),
            secondarySidebar = element(by.css('.secondary aside'));
    ...
    it('secondary sidebar closes when clicking on close button', () => {
        let filesLink = element(by.css('.primary ng-sidebar aside a.files')),
            secondarySidebar = element(by.css('.secondary aside')),
            closeBtn = element(by.css('.secondary ng-sidebar aside .close'));
    ...
    it('clicking on a file should open it', () => {
        ...
        // Open sidebar
        filesLink.click();
        element(by.css('.secondary aside ul li:first-child a.filename')).click();
        ...
        filesLink.click();
        filename = element(by.css('.secondary aside ul li:first-child a.filename'));
        filename.click();
    ...
    it('clicking on an example should open it', () => {
        ...
        // Open sidebar
        examplesLink.click();
        element(by.css('.secondary aside ul li:first-child a.example')).click();
        ...
        // Opening the same file again should direct to the same tab again
        examplesLink.click();
        filename = element(by.css('.secondary aside ul li:first-child a.example'));
        filename.click();
    ...
    it('deleting a file should work', () => {
        let saveBtn = element(by.css('.monaco-toolbar .save')),
            ...
            saveModal = element(by.css('.save-modal')),
            filenameInput = element(by.css('.save-modal input[name="filename"]')),
            count = element(by.css('ng-sidebar aside ul li a.files .count'));
        ...
        // Click delete button
        element(by.css('.secondary .files .delete')).click();
